"""
Build script to create a compiled GUI version with bytecode protection
"""
import py_compile
import shutil
import zipapp
...
def build_compiled_gui():
    ...
    if output_file.exists():
        ...
        print()
        print("Source code is compiled to bytecode (.pyc)")
        print("System tray GUI with protected code!")
        print()
        print("To run: pythonw NetworkTester_GUI.pyz")
        print("Or use: run_pyz_gui.bat (no console window)")
        print("Or double-click: NetworkTester_GUI.vbs (silent launcher)")
        print()
    else:
        print("✗ Build failed!")
        return False
